    ...
    >
      {type === "pay" && (
        <form className="container">
          ...
          <label className="form-label" htmlFor="who">
            Choose Contact
          </label>
          <select
            id="who"
          ...
          >
            ...
            {currentUser.contacts.map((c, i) => {
              if (!c.pending) {
                const x =
                  c.sendingUser.id === currentUser.id ? (
                    <option key={i} value={c.recievingUser.id}>
                      {c.recievingUser.username}
                    </option>
                  ) : (
          ...
          <label className="form-label" htmlFor="amount">
            How Much? {`(Balance: ${currentUser.balance})`}
          </label>
          <input
            className="form-control"
            id="amount"
      ...
      {type === "contact" && (
        <form>
          ...
          <label className="form-label d-block" htmlFor="search">
            Add Contact
          </label>
          <input
            type="text"
          ...
          {friend && (
            <div
              key={friend._id}
              className="p-2 mt-2 text-center border border-success rounded"
            >
              <img
                className="postimg"
            ...
            >
              ...
              {currentUser.contacts.map((c, i) => {
                return currentUser.id === c.sendingUser._id ? (
                  ...
                  <div
                    key={i}
                    className="p-1 mt-2 border border-success rounded row justify-around"
                  >
                  ...
                  <div
                    key={i}
                    className="p-1 mt-2 border border-success rounded row"
                  >
